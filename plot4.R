...
par(mfcol=c(2,2),mar=c(4.5,4.5,4.5,2),cex=0.82)
plot(data$zeit,data$activePower,type="l",xlab="",ylab="Global Active Power")
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lty=1,cex=0.85,x.intersp=1.0,y.intersp=1.25,bty="n")
plot(data$zeit,data$voltage,xlab="datetime",ylab="Voltage",type="l",col="black")
plot(data$zeit,data$reactivePower,xlab="datetime",ylab="Global_reactive_power",type="l",col="black")
dev.off()
##